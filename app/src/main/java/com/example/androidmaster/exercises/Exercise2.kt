...
Un precio para adultos mayores de USD 20 para personas de 61 años
   o más (asumimos que la edad máxima de un espectador es de 100 años)
...
fun main() {
    ...
    println("The movie ticket price for a person aged $oldSenior is \$${ticketPrice(oldSenior, isMonday)}.")
}
